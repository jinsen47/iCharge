...
//		String username=bundle.getString("name");
		...
		View mesTab = (View) LayoutInflater.from(this).inflate(R.layout.main_tab_item,null);
		TextView mes = (TextView) mesTab.findViewById(R.id.name);
		mes.setText("电桩");
		ImageView mesI =(ImageView)mesTab.findViewById(R.id.icon);
		mesI.setBackgroundResource(R.drawable.theme_ispressed);



		View lostTab = (View) LayoutInflater.from(this).inflate(R.layout.main_tab_item, null);
		TextView lost = (TextView) lostTab.findViewById(R.id.name);
		lost.setText("我要充电");
		ImageView mesl =(ImageView)lostTab.findViewById(R.id.icon);
		mesl.setBackgroundResource(R.drawable.wallpaper_ispressed);



		View foundTab = (View) LayoutInflater.from(this).inflate(R.layout.main_tab_item, null);
		TextView found = (TextView) foundTab.findViewById(R.id.name);
		found.setText("知识库");
		ImageView mesf =(ImageView)foundTab.findViewById(R.id.icon);
		mesf.setBackgroundResource(R.drawable.iconbg_ispressed);


		View toolTab = (View) LayoutInflater.from(this).inflate(R.layout.main_tab_item, null);
		TextView tool = (TextView) toolTab.findViewById(R.id.name);
		tool.setText("我的主页");
		ImageView mest =(ImageView)toolTab.findViewById(R.id.icon);
		mest.setBackgroundResource(R.drawable.screenlock_ispressed);
